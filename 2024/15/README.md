...
warehouses! It is currently running *amok*, pushing around boxes in the warehouse with no regard for lanternfish
...
![Animation Part1](animation-part1-data.gif)
![Animation Part2](animation-part2-data.gif)